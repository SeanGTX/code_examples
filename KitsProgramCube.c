...
int lasterr = 0, counterr, speed = 50;
float err = 0;

void PIDreg ()
{
	float Pn = 0.1, Dn = 0.6, In = 0.3,IIn = 0.5;
...
void music()
{
	playImmediateTone(1222,10);
	playImmediateTone(1555,10);
	playImmediateTone(1999,10);
	playImmediateTone(1666,10);
	playImmediateTone(1333,10);
}
/*
y = 1 , x = 2 , -y = 3 , -x = 4
Cubes[8] = {2,3,1,0,3,1,1,0} {1,2,3,2,0,2,1,1}
snake - Cubes[28] = {3,0,3,1,0,1,0,2,3,2,3,3,0,3,3,3,3,2,0,2,0,1,3,1,3,0,0,0}
short snake - Cubes[10] = {2,0,2,1,0,1,0,2,2,2}
circle - Cubes[8] = {0,3,3,3,3,0,0,0}
arc - Cubes[] = {0,3,3,3,3,0,3,3,0,3,0,0}
diagonal - Cubes[24] = {1,0,1,1,2,1,2,2,3,2,3,3,3,2,2,2,2,1,1,1,1,0,0,0} Cubes[8] = {1,1,2,2,3,3,0,0}
loop - Cubes[16] = {0,3,3,3,3,0,1,0,1,2,2,2,2,1,0,0}*/
